...
// we use real time data here

import React, { useState, useEffect } from "react";
import { db } from "../../firebase"; // Ensure your Firebase config is correct
import { collection, doc, onSnapshot, updateDoc } from "firebase/firestore";
import { FaChevronLeft, FaChevronRight, FaFilter, FaTimes } from "react-icons/fa";
import {OrderStatusValues} from "../../Constant/StatusValues"
const ITEMS_PER_PAGE = 10;
...
export default function OrdersTable() {
  ...
  useEffect(() => {
    ...
    // Real-time listener for Firestore updates (It make sure to decrease the race condition for state update)
