...
//         <span className="font-medium">Filter (query)</span>
//       </button>

//       {isOpen && (
//         <div className="absolute left-0 mt-2 min-w-80 bg-white border border-gray-200 rounded-md shadow-lg p-4 z-10 space-y-3" ref={filterRef}>
...
//               className="w-full text-center bg-slate-300 text-black px-3 py-2 rounded-md hover:bg-slate-300"
//             >
//               + Add filter
//             </button>
//             <button
//               onClick={clearFilters}
//               className="w-full text-center text-red-600 px-3 py-2 rounded-md bg-red-100 hover:bg-red-100"
//             >
//               Clear Filters
//             </button>
//             <button
